...
if __name__ == '__main__':
    ...
    setup(
        name='mmdet3d',
        version=get_version(),
        description=('LDMR: Learning-Dynamics-driven Memory and Review for '
                     'long-incremental 3D object detection.'),
        long_description=readme(),
        long_description_content_type='text/markdown',
        author='Peisheng Qian, Jie Xu, Xulei Yang, Na Zhao',
        author_email='qian_peisheng@a-star.edu.sg',
        keywords=('computer vision, 3D object detection, '
                  'class-incremental learning, continual learning'),
        url='https://github.com/qianpeisheng/LDMR',
