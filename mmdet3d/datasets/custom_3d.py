...
class Custom3DDataset(Dataset):
    ...
    def __init__(self,
        ...
        # load annotations
        if self.ann_file == '__memory__':
            assert type(self).load_annotations is not Custom3DDataset.load_annotations, (
                'ann_file="__memory__" requires the dataset to override '
                '`load_annotations` to provide in-memory data_infos.'
            )
